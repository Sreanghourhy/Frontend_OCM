              ...
              <div class="body pb-24">
                ...
                <template v-if="profileTopTab === 'profile'">
                            ...
                            <td>
                              ...
                              <div class="relative">
                                <ChildrenInformationComponent
                                  ...
                                  v-bind:officer="officer"
                                  :disabled="
                                    officer?.people?.marry_status !== 'married'
                                  "
                                  @changed="
                                    (val) =>
                                      onCareerSectionChanged(
                  ...
                  <!--
                            ...
                            >
                                <div class="w-full" >
                                    <div class="relative w-full font-moul text-lg text-left mb-2 text-[#1E3A8A]" >ជ. ការបញ្ជាក់អំពីស្ថានភាព</div>
                                    <table class="w-full"  >  
                                        <tbody>
                                            <tr>
                                                <td>
...
export default {
  ...
  setup(props) {
    ...
    const careerSaveGroups = [
      ...
      // { id: 'statusGroup', label: 'ជ. ការបញ្ជាក់អំពីស្ថានភាព', sections: [] }
    ];
