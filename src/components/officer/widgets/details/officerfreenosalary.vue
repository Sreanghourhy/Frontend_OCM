                        ...
                        <table class="w-full" >
                            <thead>
                                <tr class="w-full " >
                                    ...
                                    <th class="px-1 py-2 bg-gray-200 font-btb-black " >ចំនួន(ខែ/ឆ្នាំ)</th>
                            ...
                            <tbody>
                                <tr v-for="(officernosalary , index) in officernosalaries" :key="index" class="certificate relative w-full rounded-lg shadow bg-white mb-2 " >
                                    ...
                                    <td class="w-48 uppercase text-center" >{{ formatKhmerMonthDuration( officernosalary.total_months ) }}</td>
