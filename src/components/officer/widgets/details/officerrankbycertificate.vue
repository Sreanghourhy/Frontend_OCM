                        ...
                        <table class="w-full" >
                            ...
                            <tbody>
                                <tr v-for="(officerRank , index) in officerRanks" :key="index" class="certificate relative w-full rounded-lg shadow bg-white mb-2 " >
                                    ...
                                    <td class="w-48 uppercase text-center" >{{ formatRankLabel(officerRank.previousRank) }}</td>
                                    <td class="w-48 uppercase text-center" >{{ formatRankLabel(officerRank.rank) }}</td>
                                    <td class="flex w-28" >
                                        <svg 
        ...
        setup(props){
            ...
            const ranks = computed( () => {
                return store.getters['rank/records'].all.map( (r) =>  { 
                    return {
                        label: formatRankCodeLabel(r) , value: r.id 
                    }
                } )
            })
