<template>
    <div class="fixed left-0 top-0 right-0 flex title-bar border-b border-gray-200 px-2 py-1 text-gray-50" >
      <div class="flex w-64 h-8 title " >
        <div v-html="icons[icon]" ></div>
        <div class="font-moul ml-2 leading-9 text-xs " v-html="title" ></div>
      </div>
