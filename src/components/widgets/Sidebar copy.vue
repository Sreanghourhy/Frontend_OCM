  ...
  <div class="relative flex flex-wrap content-center z-50 " >
    <!-- Start transaction of the apps -->
        ...
        <Transition  name="slide-fade" >
          <div v-if="true" class="fixed top-12 bg-white bottom-0 left-0 w-40 z-40 flex flex-wrap content-start bg-opacity-95 shadow-md border-r border-gray-200 ">
              <!-- Search -->
              ...
              <div class="sidebar">
                <div v-for="(app, index) in matchedApps" :key="index" class="sidebar-item">
                  ...
                  <!-- children -->
                  <div v-if="app.children != undefined && app.children.length > 0 " class="sidebar-children" >
...
.sidebar .sidebar-item {
  @apply relative w-full border-b border-gray-200 cursor-pointer  ;
}
...
.sidebar-children-item:hover {
  @apply border-b border-blue-300 bg-blue-50 duration-300;
}
