    ...
    <div v-if="officer != undefined && officer != null " class="p-2 flex flex-wrap text-left " >
      ...
      <div class="body w-full font-sr" >
            ...
            <table v-if=" officer.people != undefined && officer.people != null " class="w-full section-bullet-table personal-info-table" >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="" colspan="2" >អុីមែល: {{ officer.people.email }}</td>
                </tr>
                <tr>
        ...
        <div class="form-panel family-info-section w-full mx-auto" >
          <div class="w-full" >
            <div class="relative w-full mb-1 flex items-center gap-6" >
              <div class="shrink-0 font-moul">ខ. ព័ត៌មានគ្រួសារ</div>
              <div class="flex items-center font-normal flex-wrap gap-x-4 gap-y-1">
                <div class="w-20 flex items-center leading-5 " >
                ...
                <div class="w-[130px] flex items-center leading-5 " >
                ...
                <div class="w-40 flex items-center leading-5 " >
              ...
              <tbody>
                <tr >
                  <td>
                    ...
                    <table class="w-full section-bullet-table parent-subsection-table" >
                      <colgroup>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="4" class="font-bold">ខ.១.ព័ត៌មានប្រពន្ធឬប្ដី</td>
                        </tr>
                        <tr >
                          <td> - ឈ្មោះប្រពន្ធឬប្តី</td>
                          <td class="parent-td-name">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_lastname + ' ' + officer.people.wedding_certificates[0].spouse_firstname : '' }}</td>
                          <td class="parent-td-status">
                            <div class="parent-td-status-inner">
                              <div class="inline-flex items-center leading-5 shrink-0">
                                <svg v-if="officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].spouse_death == 0 " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <svg v-if="officer.people.marry_status == 'single' || officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].spouse_death != 0 " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                              ...
                              <div class="inline-flex items-center leading-5 shrink-0">
                                <svg v-if="officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].spouse_death == 1" class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <svg v-if="officer.people.marry_status == 'single' || officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].spouse_death != 1" class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                                <svg v-if="officer.people.wedding_certificates == undefined || officer.people.wedding_certificates == null " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                ស្លាប់
                              </div>
                            </div>
                          </td>
                          <td class="parent-td-dob"></td>
                        </tr>
                        <tr >
                          <td> - ឈ្មោះជាអក្សរពុម្ពឡាតាំង</td>
                          <td colspan="3">{{officer.people.marry_status !== 'single' &&  officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_enlastname + ' ' + officer.people.wedding_certificates[0].spouse_enfirstname : '' }}</td>
                        </tr>
                        <tr >
                          <td> - ថ្ងៃខែឆ្នាំកំណើត</td>
                          <td colspan="3" class="parent-td-dob">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? $toKhmer( formatKhmerDateWithMonthName( officer.people.wedding_certificates[0].spouse_dob ) ) : '' }}</td>
                        </tr>
                        <tr >
                          <td> - លេខអត្ត.សញ្ជាតិខ្មែរ</td>
                          <td colspan="3">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? $toKhmer( officer.people.wedding_certificates[0].spouse_nid ) : '' }}</td>
                        </tr>
                        <tr >
                          <td> - ទីកន្លែងកំណើត</td>
                          <td colspan="3">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_pob : '' }}</td>
                        </tr>
                        <tr >
                          <td> - មុខរបរបច្ចុប្បន្ន</td>
                          <td colspan="3">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_profession : '' }}</td>
                        </tr>
                        <tr >
                          <td> - ឈ្មោះអង្គភាព</td>
                          <td colspan="3">{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_profession_organization : '' }}</td>
                        </tr>
                        <tr >
                          <td> - អាសយដ្ឋានបច្ចុប្បន្ន</td>
                          <td colspan="3" >{{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 ? officer.people.wedding_certificates[0].spouse_address : '' }}</td>
                        </tr>                        
                      </tbody>
                    </table>
                  </td>
                ...
                <tr >
                  <td>
                    ...
                    <table class="w-full section-bullet-table" >
                      <tbody>
                        <tr>
                          <td class="w-48 font-bold">
                              ខ.២.ព័ត៌មានកូន
                          </td>
                        </tr>
                        <tr >
                          <td class="w-20" >មានកូនចំនួន {{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].birth_certificates != undefined && officer.people.wedding_certificates[0].birth_certificates != null && officer.people.wedding_certificates[0].birth_certificates.length > 0 ? $toKhmer( officer.people.wedding_certificates[0].birth_certificates.length ) : '' }} នាក់</td>
                          <td class="w-[81%]" >ស្រីចំនួន {{ officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].birth_certificates != undefined && officer.people.wedding_certificates[0].birth_certificates != null && officer.people.wedding_certificates[0].birth_certificates.length > 0 ? $toKhmer( officer.people.wedding_certificates[0].birth_certificates.filter( ( b ) => b.gender != 'male' ).length ) : '' }} នាក់</td>
                        </tr>
                        <tr v-if="officer.people.marry_status !== 'single' && officer.people.wedding_certificates != undefined && officer.people.wedding_certificates.length > 0 && officer.people.wedding_certificates[0].birth_certificates != undefined && officer.people.wedding_certificates[0].birth_certificates != null && officer.people.wedding_certificates[0].birth_certificates.length > 0" >
                          <td colspan="4" >
                            <div v-for="(o,i) in officer.people.wedding_certificates[0].birth_certificates"  :key="i"
                              class="w-full " >
                              <div class="w-full flex py-0.5 " >
                                <div class="w-[17%]" > - គោត្តនាម និងនាមខ្លួន:
                                  </div>
                                 <div class="w-48"> {{ o.lastname + ' ' + o.firstname }}</div>
                                <div class="w-[10%]" >ភេទ : {{ o.gender == "male" ? 'ប្រុស' : 'ស្រី' }}</div>
                                <div class="w-3/12" >ថ្ងៃខែឆ្នាំកំណើត : {{ $toKhmer( formatKhmerDateWithMonthName( o.dob ) ) }}</div>
                              </div>
                              <div class="w-full flex py-0.5 " >
                                <div class="w-[17%]" > - មុខរបរ: 
                                  </div>
                                  <div class="w-48">
                                  {{ o.profession }}</div>
                        ...
                        <tr v-else>
                          <td colspan="4" >
                            <div class="w-full flex py-0.5">
                              <div class="w-[17%]"> - គោត្តនាម និងនាមខ្លួន:</div>
                              <div class="w-48"></div>
                              <div class="w-[10%]">ភេទ :</div>
                              <div class="w-3/12">ថ្ងៃខែឆ្នាំកំណើត :</div>
                            </div>
                            <div class="w-full flex py-0.5">
                              <div class="w-[17%]"> - មុខរបរ:</div>
                              <div class="w-48"></div>
                              <div class="w-3/12">ក្នុងបន្ទុក ស្ថានភាព :</div>
                            </div>
                          </td>
                ...
                <tr>
                  <td>
                    ...
                    <table class="w-full  section-bullet-table parent-subsection-table" >
                      ...
                      <tbody>
                        <tr>
                          <td colspan="4" class="font-bold">ខ.៣.ព័ត៌មានឪពុកនិងម្ដាយបង្កើត</td>
                        </tr>
                        <tr>
                          <td> - ឪពុកឈ្មោះ </td>
                          <td class="parent-td-name">{{ officer.people.father_lastname }} {{ officer.people.father_firstname }}</td>
                          <td class="parent-td-status">
                            <div class="parent-td-status-inner">
                              <div class="inline-flex items-center leading-5 shrink-0">
                                <svg v-if="officer.people.father_lastname !== '' && officer.people.father_death != undefined && officer.people.father_death == 0 " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <svg v-if="officer.people.father_lastname == '' || officer.people.father_death != undefined && officer.people.father_death != 0  " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                              ...
                              <div class="inline-flex items-center leading-5 shrink-0">
                                ...
                                <svg v-if="officer.people.father_lastname == '' || officer.people.father_death != undefined && officer.people.father_death != 1" class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                                <svg v-if="officer.people.father_death != undefined && officer.people.father_death == null " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                ស្លាប់
                              </div>
                            </div>
                          </td>
                          <td class="parent-td-dob">{{ officer.people.mother_lastname !== '' && officer.people.father_dob != undefined && officer.people.father_dob.length > 0 ? $toKhmer( formatKhmerDateWithMonthName( officer.people.father_dob, true ) ) : '' }}</td>
                        </tr>
                        <tr>
                          <td> - ទីកន្លែងកំណើត​ </td>
                    ...
                    <table class="w-full section-bullet-table parent-subsection-table" >
                      ...
                      <tbody>
                        <tr>
                          <td> - ម្ដាយឈ្មោះ </td>
                          <td class="parent-td-name">{{ officer.people.mother_lastname }} {{ officer.people.mother_firstname }}</td>
                          <td class="parent-td-status">
                            <div class="parent-td-status-inner">
                              <div class="inline-flex items-center leading-5 shrink-0">
                                <svg v-if="officer.people.mother_lastname !== '' && officer.people.mother_death != undefined && officer.people.mother_death == 0 " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <svg v-if="officer.people.mother_lastname == '' || officer.people.mother_death != undefined && officer.people.mother_death != 0 " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                              ...
                              <div class="inline-flex items-center leading-5 shrink-0">
                                <svg v-if="officer.people.mother_lastname !== '' && officer.people.mother_death != undefined && officer.people.mother_death == 1" class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <svg v-if="officer.people.mother_lastname == '' || officer.people.mother_death != undefined && officer.people.mother_death != 1" class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="black" stroke-width="1.5"/></svg>
                                <svg v-if="officer.people.mother_death != undefined && officer.people.mother_death == null " class="w-3 h-3 mr-1 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="black"/><path d="M6 12.5L10 16.5L18 8.5" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                ស្លាប់
                              </div>
                            </div>
                          </td>
                          <td class="parent-td-dob">{{ officer.people.mother_lastname !== '' && officer.people.mother_dob != undefined && officer.people.mother_dob.length > 0 ? $toKhmer( formatKhmerDateWithMonthName( officer.people.mother_dob, true ) ) : '' }}</td>
                        </tr>
                        <tr>
                          <td> - ទីកន្លែងកំណើត​ </td>
        ...
        <div class="form-panel contact-info-section w-full mx-auto" >
          <div class="w-full" >
            <div class="relative w-full mb-1 font-moul text-left" >គ. ព័ត៌មានទំនាក់ទំនងក្នុងករណីមានអាសន្ន</div>
            <table class="w-full section-bullet-table" >
              <tbody>
                <tr>
                  <td class="w-[19%]" > -  ឈ្មោះជាភាសាខ្មែរ </td>
                  <!-- &nbsp is Non-Breaking Space -->
                  <td >{{ officer.people.emergency_lastname  ? 'គោត្តនាម : ' + officer.people.emergency_lastname  : 'គោត្តនាម : ' }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{  officer.people.emergency_firstname ?' នាមខ្លួន : ' + officer.people.emergency_firstname : 'នាមខ្លួន : ' }}</td>
                  <td colspan="2" >ភេទ : {{ parseInt( officer.people.gender ) == 1 ? 'ប្រុស' : 'ស្រី' }}</td>
                
                </tr>
                <tr>
                  <td class="w-[19%]" > - ទំនាក់ទំនងត្រូវជា  </td>
                  <td > {{ officer.people.emergency_relationship }} </td>
                  <td>មុខរបរ : {{ officer.people.emergency_profession }}</td>
                ...
                <tr>
                  ...
                  <td >អុីមែល :​ {{ officer.people.emergency_email }}</td>
                </tr>
              </tbody>
            </table>
          </div>
                ...
                <tr>
                  <td>
                    <table class="inside w-full border border-gray-100 " >
                      ...
                      <tbody>
                          <tr>
                            <td colspan="7" class="border-b border-gray-100 " >១-កម្រិតវប្បធម៌ទូទៅ (សូមបំពេញកម្រិតចុងក្រោយ)</td>
                          </tr>
                          ...
                          <tr>
                            <td colspan="7" class="border-b border-gray-100 " >២-កម្រិតបណ្ដុះបណ្ដាលវិជ្ជាជីវៈមូលដ្ឋាន និងក្រោយមូលដ្ឋាន (សូមបំពេញតាមលំដាប់ថ្មីទៅចាស់)</td>
                          </tr>
                          ...
                          <tr>
                            <td colspan="7" class="border-b border-gray-100 " >៣-វគ្គបណ្ដុះបណ្ដាលផ្សេងៗ (សូមបំពេញវគ្គសក្សាថ្មី សំខាន់ៗ និងចាំបាច់)</td>
                          </tr>
            ...
            <table class="inside w-full" >
              ...
              <tbody>
                <tr v-for="(language , index) in (officer.people.languages || [])" :key="index" >
                  ...
                  <td class="border-b border-gray-100 text-center" >{{ formatLanguageGrade(language.reading) }}</td>
                  <td class="border-b border-gray-100 text-center" >{{ formatLanguageGrade(language.speaking) }}</td>
                  <td class="border-b border-gray-100 text-center" >{{ formatLanguageGrade(language.writing) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
                        ...
                        <table class="inside w-full border border-gray-100 " >
                            ...
                            <tbody>
                                <tr v-for="(job,index) in officer.job_backgrounds.filter( (jb) => jb.sector == 0 )" :key="index" >
                                    ...
                                    <td class="border-b border-gray-100 text-center" >{{ $toKhmer( formatCareerEndDate(job.end) ) }}</td>
                    ...
                    <table class="inside w-full border border-gray-100 " >
                      ...
                      <tbody>
                        <tr v-for="(rank , index) in officer.ranking_by_workings " :key="index" >
                          ...
                          <td class="border-b border-gray-100 text-center" >{{ formatRankForPrint(rank.previous_rank) }}</td>
                          <td class="border-b border-gray-100 text-center" >{{ formatRankForPrint(rank.rank) }}</td>
        ...
        <div class="form-panel     w-full mx-auto mt-4" >
          <div class="w-full " >
            <div class="relative w-full pb-2 font-moul " >ជ. តួនាទីផ្សេងៗ</div>
            <table class="w-full"  >
              <tbody>
                <tr>
                  <td>
                    <table class="inside w-full border border-gray-100 " >
                      ...
                      <tbody>
                        <tr v-for="(job,index) in officer.job_backgrounds.filter( (jb) => jb.sector == 2 )" :key="index" >
                          <td class="border-b border-gray-100 text-center" >{{ $toKhmer( formatKhmerSlashDateMonthName( job.start ) ) }}</td>
        ...
        <div class="w-full relative h-60" >
          <div class="py-2 pl-7 " >ខ្ញុំសូមធានាទទួលខុសត្រូវចំពោះមុខច្បាប់ ព័ត៌មានបានបំពេញក្នុងជីវប្រវត្តិនេះ ពិតជាត្រឹមត្រូវប្រាកដមែន។</div>
  ...
  export default {
      ...
      setup(props){
        ...
        function formatLanguageGrade (value) {
          ...
          function formatCareerEndDate(value) {
            if (value == null || String(value).trim() === '') {
              return 'បច្ចុប្បន្ន'
            }
            return formatKhmerSlashDateMonthName(value)
          }
          function formatRankForPrint(rank) {
            if (!rank) return ''
            return formatRankCodeLabel(rank) || rank?.thnak || rank?.name || ''
          }
