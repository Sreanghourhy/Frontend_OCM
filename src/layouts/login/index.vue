<template>
    <div class="relative flex min-h-screen " :style=" ' background-image: url( ' + pkachan + ' ); ' " >
      <Transition name="slide-fade" >
      <div v-if="toggleLoginForm" class="w-96 mx-auto p-8 mt-20">
        ...
        <div class="w-full mx-auto leading-6 text-center font-moul mb-8 my-2">{{ store.state.system.name }}</div>
