      ...
      <Transition name="slide-fade" >
        <div v-if="visibleHelper" class="portal-panel mt-8 py-10" >
          <div class="portal-services ">
            ...
            <div v-if="$hasPermission('portal_orgchart')" class="portal-service-item">
...
.portal-service-item .portal-service-content {
  @apply w-full p-4 cursor-pointer rounded-lg bg-white border border-gray-200 hover:border-blue-400 duration-500 transform hover:scale-105 ;
}
