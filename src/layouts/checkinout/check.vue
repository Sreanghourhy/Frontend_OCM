<template>
  <div class="absolute left-0 top-0 right-0 bottom-0 " >
    <div class="
    w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-6/12 2xl:w-3/12 
    m-4 p-8 mx-auto mt-2 mb-24 relative z-40">
          ...
          <div class="w-full p-1 mx-auto" >
            <div v-if="organization != null && organization != undefined && checkAttendantStatus == false " class="p-2 w-full leading-5 flex flex-wrap relative cursor-pointer" >
                ...
                <div class="w-full text-center m-2 relative" >
                  ...
                  <div class="w-full text-left text-xs " >
                    <n-tabs type="line" animated class="" v-model:value="tabValueChange" @update:value="tabChange" >
                      ...
                      <n-tab-pane name="phone" tab="លេខទូរស័ព្ទ">
                        <n-tooltip trigger="hover">
                          <template #trigger>
                            <n-input 
                    ...
                    <div class="text-yellow-800 w-full py-2 leading-5 text-xs hidden " >* អ៉ីមែល និង លេខទូរស័ព្ទ អាចបញ្ចូលមួយណាក៏បាន ឬ ទាំង ២។</div>
                  </div>
              ...
              <!-- <Transition name="slide-fade" >
                ...
                <div v-else class="" >ផែនទីមិនដំណើរការ</div>
              </Transition> -->
            </div>
          </div>
        </div>
    ...
    <Transition name="slide-fade" >
      <div v-if="identification!=null" class="z-50 fixed left-0 top-0 right-0 bottom-0 bg-white flex flex-wrap overflow-y-auto" >
        <div class="relative w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-6/12 2xl:w-6/12 m-4 p-8 mx-auto" >
          ...
          <div v-if="identification.avatar_url != undefined && identification.avatar_url != '' " class="w-full mb-4 mx-auto bg-contain bg-no-repeat bg-center" >
          ...
          <div class="w-full p-4" >
            ...
            <div v-if="attendant==null || ( attendant != null && checkStatus == -1 )" >
              <div @click="checkAttendant" class="cursor-pointer w-1/4 mx-auto" ><div class="border border-green-400 bg-green-100 rounded-md text-black p-4 w-full mx-auto" >ចុះវត្តមាន ចូល</div></div>
            </div>
            <Transition name="slide-fade" >
              <div v-if="attendant!=null && ( checkStatus == 0 || checkStatus == 1 ) " >
                <div @click="checkAttendant" class="cursor-pointer w-1/2 mx-auto" ><div class="border border-green-400 bg-green-100 rounded-md p-4 w-full mx-auto" >
  ...
  setup(){
    ...
    function getLocation() {
        if (navigator.geolocation) {
            ...
            notify.error( {
              title : 'មានកំហុស' ,
              content: "មិនអាចចាប់ទីតាំងអ្នកប្រើប្រាស់។" ,
              duration: 3000
            } )
        }
    }
